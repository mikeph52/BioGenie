...
- Issue (https://github.com/mikeph52/BioGenie/issues/37) fixed.
- Minor bugs fixed.

### 0.28.0 (January 28th, 2026):
- Pairwise Sequence Alignment with Needleman-Wunsch added.
- Issue (https://github.com/mikeph52/BioGenie/issues/34) fixed.
- Minor bugs fixed.

### 0.27.0 (January 25th, 2026):
- Multi core support added for pip1, pip2 and pip3(https://github.com/mikeph52/BioGenie/issues/30), (https://github.com/mikeph52/BioGenie/issues/31).
